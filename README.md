...
[![TailwindCSS](https://img.shields.io/badge/Tailwind-4.1-38BDF8?style=for-the-badge&logo=tailwind-css&logoColor=white)](https://tailwindcss.com/)
...
_Este proyecto es un portafolio personal desarrollado con Astro, React, TailwindCSS y soporte para internacionalización (i18n). Permite mostrar tus proyectos, habilidades y experiencia, con la capacidad de cambiar entre diferentes idiomas._
...
-   **[Astro 5.15](https://astro.build/)** - Framework web moderno para sitios rápidos
